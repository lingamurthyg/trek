 ...
 *
 * Migrated from Hibernate 3.6 + spring-orm-hibernate3 to Hibernate 5.6 + spring-orm-hibernate5.
 * Key changes:
 *  - org.hibernate.Query  -> org.hibernate.query.Query  (Hibernate 5+)
 *  - HibernateDaoSupport  -> org.springframework.orm.hibernate5.support.HibernateDaoSupport
 *
 * @author Rajesh Kumar
